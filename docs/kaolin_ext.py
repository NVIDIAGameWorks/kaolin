...
def run_apidoc(_):
    ...
    EXCLUDE_PATHS = [
        str(os.path.join(KAOLIN_ROOT, path)) for path in [
            ...
            "kaolin/version.py",
            "kaolin/app/",
            "kaolin/experimental/dash3d/",
            "kaolin/experimental/newton/builder.py",
            "kaolin/experimental/newton/model.py",
            "kaolin/experimental/newton/state.py",
            "kaolin/experimental/newton/solver.py",
            "kaolin/experimental/newton/collisions.py",
            "kaolin/version.txt",
            ...
            "kaolin/ops/gaussians/densifier.py",
            ...
            "kaolin/visualize/dash/components/",
            "kaolin/visualize/dash/distr/",
            # Documented by hand in grouped pages (viewer_group / app_group /
            # utilities), so suppress per-module apidoc stubs to avoid orphans.
            "kaolin/visualize/dash/viewer.py",
            "kaolin/visualize/dash/builtins.py",
            "kaolin/visualize/dash/option.py",
            "kaolin/visualize/dash/auto_ui.py",
            "kaolin/visualize/dash/layout.py",
            "kaolin/visualize/dash/builder.py",
            "kaolin/visualize/dash/assets_helper.py",
            "kaolin/visualize/dash/behavior_manifest.py",
            "kaolin/visualize/dash/user_behavior_scan.py",
            "kaolin/framework/*",
