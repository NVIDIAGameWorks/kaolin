...
parser.add_argument('--batchsize', type=int, default=1,
                    help='Batch size.')
parser.add_argument('--f-score', action='store_true',
                    help='compute F-score')
...
meshes_set_valid = kal.datasets.ShapeNet_Meshes(root=args.shapenet_root, categories=args.categories,
                                                train=False, split=.7)
valid_set = kal.datasets.ShapeNet_Combination([points_set_valid, images_set_valid, meshes_set_valid])
