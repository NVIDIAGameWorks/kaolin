...
sdf_set = kal.datasets.ShapeNet_SDF_Points(root='../../datasets/', cache_dir='cache/', categories=args.categories,
                                           train=False, split=.7, num_points=100000, occ=True)
data_set_mesh = kal.datasets.ShapeNet_Meshes(root='../../datasets/',
                                             categories=args.categories, train=False, split=.7)


valid_set = kal.datasets.ShapeNet_Combination(
    [sdf_set, images_set, data_set_mesh, points_set_valid], root='../../datasets/')
