...
train_set = kal.datasets.ShapeNet.Combination([sdf_set, images_set], root='../../datasets/')
...
valid_set = kal.datasets.ShapeNet.Combination([sdf_set, images_set], root='../../datasets/')
