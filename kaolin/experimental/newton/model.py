...
class SimplicitsModel(newton.Model):
    ...
    def sim_z_to_full(self, sim_z: wp.array):
        ...
        Returns:
            wp.array: Full particle positions (dtype=wp.vec3), or empty array if scene uninitialized.
        """
    ...
    def sim_z_dot_to_full(self, sim_z_dot: wp.array):
        ...
        Returns:
            wp.array: Full particle velocities (dtype=wp.vec3), or empty array if scene uninitialized.
        """
