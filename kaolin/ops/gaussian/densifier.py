...
import warnings
from ..gaussians import sample_points_in_volume as new_sample_points_in_volume
...
def sample_points_in_volume(
    ...
    .. deprecated::
        ...
        This function has been relocated to kaolin.ops.gaussians
    ...
    """
    warnings.warn(
        "kaolin.ops.gaussian.sample_points_in_volume has been moved in kaolin.ops.gaussians.sample_points_in_volume",
        DeprecationWarning, stacklevel=2)
    return new_sample_points_in_volume(
        xyz,
        scale,
        rotation,
        opacity,
        ...
        post_scale_factor,
        jitter,
        clip_samples_to_input_bbox,
        viewpoints,
        scaling_activation,
        scaling_inverse_activation)
