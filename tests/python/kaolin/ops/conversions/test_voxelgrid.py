...
class TestMarchingCube:
    ...
    def _all_variations_test(self, voxelgrid, expected_vertices):
        ...
        all_rotations = [[0, 1, 2], [0, 2, 1], [1, 0, 2], [2, 1, 0]]
        all_flips = [[], [0], [1], [2], [0, 1], [0, 2], [1, 2], [0, 1, 2]]

        for rotate in all_rotations:
            new_vertices, new_expected_vertices, new_voxelgrid = self._rotate(voxelgrid, expected_vertices, rotate)
            
            for flip in all_flips:
                curr_vertices, curr_expected_vertices, _ = self._flip(new_voxelgrid, new_expected_vertices, flip)
